...
class ArdProjectStructureDetector : ProjectStructureDetector() {
    ...
    override fun detectRoots(
        ...
        val containsArendFile = dir
                .walk()
                .any { it.extension == ArdFileType.defaultExtension }
    ...
    override fun createWizardSteps(
            ...
            projectDescriptor: ProjectDescriptor,
            stepIcon: Icon?
    ): List<ModuleWizardStep> = listOf(ArdModuleWizardStep(builder.context, projectDescriptor))
}
