...
class ArdCallHierarchyProvider : HierarchyProvider {
    override fun createHierarchyBrowser(target: PsiElement): HierarchyBrowser {
        return ArdCallHierarchyBrowser(target.project, target)
    }

    override fun browserActivated(hierarchyBrowser: HierarchyBrowser) {
        (hierarchyBrowser as ArdCallHierarchyBrowser).changeView(CallHierarchyBrowserBase.CALLER_TYPE)
    }
