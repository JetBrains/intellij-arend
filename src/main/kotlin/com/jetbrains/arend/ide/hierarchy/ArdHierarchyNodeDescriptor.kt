package com.jetbrains.arend.ide.hierarchy
...
class ArdHierarchyNodeDescriptor(project: Project, parent: HierarchyNodeDescriptor?,
    ...
    //    return (psiElement as ArdReferenceElement).reference?.resolve() as PsiGlobalReferable
    // }
