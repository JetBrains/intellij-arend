...
class ArdPrettyPrinterFormatAction : AnAction(), DumbAware {

    override fun update(e: AnActionEvent) {
        val psiFile = e.getData(CommonDataKeys.PSI_FILE)
        e.presentation.isEnabled = psiFile is ArdFile
    }

    override fun actionPerformed(e: AnActionEvent) {
        val psiFile = e.getData(CommonDataKeys.PSI_FILE)
        val project = AnAction.getEventProject(e) ?: return
        if (psiFile !is ArdFile) return
    ...
    private companion object {
        ...
        private val LOG = Logger.getInstance(ArdPrettyPrinterFormatAction::class.java)

        private fun prettyPrint(module: ArdFile): String? {
            return null
            /* TODO[pretty]
