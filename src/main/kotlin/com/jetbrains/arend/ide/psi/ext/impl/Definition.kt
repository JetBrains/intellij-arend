...
abstract class DefinitionAdapter<StubT> : ReferableAdapter<StubT>, ChildGroup, Abstract.Definition, PsiConcreteReferable
    ...
    open fun getWhere(): ArdWhere? = null
    ...
    override fun getNamespaceCommands(): List<ArdStatCmd> = getWhere()?.statementList?.mapNotNull { it.statCmd }
            ?: emptyList()
    ...
    override fun getEnclosingClass(): ClassReferable? {
        ...
        while (parent != null && parent !is ArdFile) {
