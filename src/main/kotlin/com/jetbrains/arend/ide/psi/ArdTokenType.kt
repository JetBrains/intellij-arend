...
class ArdTokenType(debugName: String) : IElementType(debugName, com.jetbrains.arend.ide.ArdLanguage.INSTANCE)
...
val VC_KEYWORDS: TokenSet = TokenSet.create(
        ...
        PROP_KW, WHERE_KW, WITH_KW, ELIM_KW, NEW_KW, PI_KW, SIGMA_KW, LAM_KW, LET_KW,
