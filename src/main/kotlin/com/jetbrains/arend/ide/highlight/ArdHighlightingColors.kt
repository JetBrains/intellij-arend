...
enum class ArdHighlightingColors(humanName: String, default: TextAttributesKey) {
    ...
    val textAttributesKey = TextAttributesKey.createTextAttributesKey("com.jetbrains.arend.ide.$name", default)
