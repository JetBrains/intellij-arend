...
class TestBasedTypechecking(
    ...
    : ArendTypechecking(typeCheckingService, concreteProvider, errorReporter, dependencyListener, LibraryArendExtensionProvider(typeCheckingService.libraryManager)) {
