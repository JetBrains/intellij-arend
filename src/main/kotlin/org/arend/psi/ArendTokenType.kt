...
val AREND_KEYWORDS: TokenSet = TokenSet.create(
        OPEN_KW, IMPORT_KW, USING_KW, AS_KW, HIDING_KW, FUNC_KW, SFUNC_KW, LEMMA_KW, CONS_KW, STRICT_KW, CLASSIFYING_KW, NO_CLASSIFYING_KW, FIELD_KW, PROPERTY_KW, OVERRIDE_KW,
