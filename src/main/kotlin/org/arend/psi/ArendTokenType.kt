...
val AREND_KEYWORDS: TokenSet = TokenSet.create(
        OPEN_KW, IMPORT_KW, USING_KW, AS_KW, HIDING_KW, FUNCTION_KW, LEMMA_KW, CLASSIFYING_KW, FIELD_KW, PROPERTY_KW, NON_ASSOC_KW,
        LEFT_ASSOC_KW, RIGHT_ASSOC_KW, INFIX_NON_KW, INFIX_LEFT_KW, INFIX_RIGHT_KW,
        PROP_KW, WHERE_KW, WITH_KW, USE_KW, COWITH_KW, ELIM_KW, NEW_KW, PI_KW, SIGMA_KW, LAM_KW, LET_KW,
        IN_KW, CASE_KW, WITH_KW, DATA_KW, CLASS_KW, RECORD_KW, MODULE_KW, EXTENDS_KW,
        RETURN_KW, COERCE_KW, INSTANCE_KW, TRUNCATED_KW,
        LP_KW, LH_KW, SUC_KW, MAX_KW, LEVEL_KW,
        SET, UNIVERSE, TRUNCATED_UNIVERSE, THIS_KW
)

val AREND_COMMENTS: TokenSet = TokenSet.create(LINE_COMMENT, BLOCK_COMMENT, BLOCK_DOC_COMMENT_START, BLOCK_COMMENT_END, LINE_DOC_COMMENT_START, LINE_DOC_TEXT)
