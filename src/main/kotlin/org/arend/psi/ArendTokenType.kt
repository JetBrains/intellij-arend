...
val AREND_KEYWORDS: TokenSet = TokenSet.create(
        OPEN_KW, IMPORT_KW, USING_KW, AS_KW, HIDING_KW, FUNC_KW, SFUNC_KW, LEMMA_KW, TYPE_KW, CONS_KW, STRICT_KW, CLASSIFYING_KW, NO_CLASSIFYING_KW, FIELD_KW, PROPERTY_KW, DEFAULT_KW, OVERRIDE_KW,
        ...
        LP_KW, LH_KW, OO_KW, SUC_KW, MAX_KW, LEVEL_KW, LEVELS_KW,
