...
import org.arend.psi.ArendSigmaTypeTele
...
abstract class ArendSigmaExprImplMixin(node: ASTNode) : ArendExprImplMixin(node), ArendSigmaExpr, Abstract.ParametersHolder {
    override fun <P : Any?, R : Any?> accept(visitor: AbstractExpressionVisitor<in P, out R>, params: P?): R =
        visitor.visitSigma(this, sigmaTypeTeleList, params)

    override fun getParameters(): List<ArendSigmaTypeTele> = sigmaTypeTeleList
}
