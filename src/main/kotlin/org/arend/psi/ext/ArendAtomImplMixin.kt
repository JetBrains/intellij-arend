...
abstract class ArendAtomImplMixin(node: ASTNode) : ArendExprImplMixin(node), ArendAtom {
    override fun <P : Any?, R : Any?> accept(visitor: AbstractExpressionVisitor<in P, out R>, params: P?): R {
        ...
        (number
                ?: negativeNumber)?.let { return visitor.visitNumericLiteral(this, BigInteger(it.text), if (visitor.visitErrors()) org.arend.psi.ext.getErrorData(this) else null, params) }
