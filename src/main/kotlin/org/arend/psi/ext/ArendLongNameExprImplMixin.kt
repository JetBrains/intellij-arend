    ...
    override fun <P : Any?, R : Any?> accept(visitor: AbstractExpressionVisitor<in P, out R>, params: P?): R {
        ...
        if (levels != null) {
            ...
            if (levelExprsList.size == 2) {
                return visitor.visitReference(name, name.referent, null, levelExprsList[0]?.levelExprList ?: levelExprsList[0]?.atomLevelExpr?.let { listOf(it) }, levelExprsList[1]?.levelExprList ?: levelExprsList[1]?.atomLevelExpr?.let { listOf(it) }, params)
            }
        }
