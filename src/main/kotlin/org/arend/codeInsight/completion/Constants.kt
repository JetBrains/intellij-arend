...
val STATEMENT_WT_KWS = listOf(FUNCTION_KW, LEMMA_KW, DATA_KW, CLASS_KW, RECORD_KW, INSTANCE_KW, OPEN_KW, MODULE_KW).map { it.toString() }
...
val PRELUDE_CONSTRUCTORS = listOf("left", "path", "right", "suc", "zero", "neg", "pos")
val PRELUDE_DEFINITIONS = PRELUDE_CONSTRUCTORS + listOf("Nat", "Int", "I", "Path", "=", "@", "coe", "iso")
