...
val STATEMENT_WT_KWS = listOf(FUNC_KW, SFUNC_KW, FUNC_S_KW, LEMMA_KW, CONS_KW, CONS_S_KW, DATA_KW, CLASS_KW, RECORD_KW, INSTANCE_KW, OPEN_KW, MODULE_KW, META_KW).map { it.toString() }
