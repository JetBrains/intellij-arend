...
class RemoveTruncatedKeywordQuickFix(private val cause: SmartPsiElementPointer<PsiElement>) : IntentionAction {
    ...
    override fun invoke(project: Project, editor: Editor?, file: PsiFile?) {
        val arendDefData = cause.element as? ArendDefData ?: return
        arendDefData.truncatedKw?.deleteWithWhitespaces()
    }
}
