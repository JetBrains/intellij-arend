...
class RemoveAsPatternQuickFix (private val asPatternPointer: SmartPsiElementPointer<ArendAsPattern>): IntentionAction {
    override fun startInWriteAction(): Boolean = true

    override fun getFamilyName(): String = "arend.pattern"

    override fun isAvailable(project: Project, editor: Editor?, file: PsiFile?): Boolean = asPatternPointer.element != null

    override fun getText(): String = "Remove \\as-pattern"

    override fun invoke(project: Project, editor: Editor?, file: PsiFile?) {
        val asPattern = asPatternPointer.element ?: return
