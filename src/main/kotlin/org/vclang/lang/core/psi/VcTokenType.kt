...
val VC_KEYWORDS = TokenSet.create(
        ...
        ELIM_KW, FIELD_KW, NEW_KW, PI_KW, SIGMA_KW, LAM_KW, LET_KW,
        IN_KW, CASE_KW, WITH_KW, IMPLEMENT_KW, DATA_KW, CLASS_KW,
        EXTENDS_KW, VIEW_KW, ON_KW, BY_KW, INSTANCE_KW, TRUNCATED_KW,
