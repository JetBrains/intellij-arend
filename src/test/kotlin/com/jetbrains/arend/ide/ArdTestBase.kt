...
abstract class ArdTestBase : LightPlatformCodeInsightFixtureTestCase(), ArdTestCase {
    ...
    override fun getTestDataPath(): String = "${ArdTestCase.testResourcesPath}/$dataPath"
    ...
    override fun setUp() {
        ...
        val library = ArdRawLibrary(myModule, service.typecheckerState)
    ...
    inner class InlineFile(@Language("Arend") private val code: String, name: String = "Main.vc") {
